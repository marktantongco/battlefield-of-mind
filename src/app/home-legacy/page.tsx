...
export default async function HomeLegacy() {
  let posts = []
  try {
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="text-center max-w-5xl mx-auto mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Where mental transformation meets AI-powered creativity. A
              synergized platform for personal growth and content innovation.
            </p>
          </div>
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500/10 via-orange-500/10 to-red-500/10 border-2 border-amber-500/20 hover:border-amber-500/40 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-amber-500/20">
                ...
                <div className="relative p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                    Navigate your inner landscape. Transform limiting beliefs
                    into empowering truths through interactive exercises and
                    proven frameworks.
                  </p>
            ...
            <Link href="/ai-tools" className="group">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 via-cyan-500/10 to-teal-500/10 border-2 border-blue-500/20 hover:border-blue-500/40 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20">
                ...
                <div className="relative p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                    Harness AI to amplify your creativity. Generate ideas,
                    optimize content, and build your digital presence with
                    cutting-edge tools.
                  </p>
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Inner transformation fuels outer creation. Master your mindset
              through the Battlefield, then channel that clarity into powerful
